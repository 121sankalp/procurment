    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      // Submit these to a database
        ...
        error_reporting(0) ;
           ...
           $sql=  "UPDATE `drugs` SET `first` = '$a1', `second` = '$a2', `third` = '$a3', `fourth` = '$a4', `fifth` = '$a5', `sixth` = '$a6', `seventh` = '$a7', `eighth` = '$a8', `nineth` = '$a9', `tenth` = '$a10', `eleventh` = '$a11', `tweleveth` = '$a12', `thirteenth` = '$a13' WHERE `drugs`.`sno` = '$n';";
