...
if($userprofile==false) 
{
  ...
  <META HTTP-EQUIV="Refresh" CONTENT="0; URL=http://localhost:80/pro/pages/logout.php">
...
$ql="SELECT * FROM `equipment`";
$pl="SELECT * FROM `userdetails`";

$res = mysqli_query($conn, $ql);
 
$res1 = mysqli_query($conn, $pl);
...
$result = mysqli_query($conn, $sql);
  ...
  $y = "EQUIP";
    ...
    $test1[$count]["label"] ="drugs" ; 

    $test1[$count]["y"] ="$num1" ;

     $test2[$count]["label"] ="DRUGS/EQUIP" ; 
...
<aside
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-4">
          ...
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">TOTAL DRUGS TENDER</p>
                <h4 class="mb-0"><?php  echo "$num1"; ?></h4>
              </div>
            </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">TOTAL EQUIPMENT TENDER</p>
                <h4 class="mb-0"><?php  echo "$num2"; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
          <div class="card">
            <div class="card-header p-3 pt-2">
              ...
              <div class="text-end pt-1">
                <p class="text-sm mb-0 text-capitalize">TOTAL USERS REGISTERED</p>
                <h4 class="mb-0"><?php  echo "$num3"; ?></h4>
              </div>
            </div>
            <hr class="dark horizontal my-0">
            <div class="card-footer p-3">
      ...
      <div class="row mt-5">
        <div class="col-lg-8 col-md-6 mt-6 mb-4">
